...
const FAQ_ITEMS: AccordionItem[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '→ Subscription management across reinstalls.',
  ...
  },
  {
    ...
    content: [
      ...
      '2. Choose your plan (weekly, monthly, or yearly).',
      '3. Complete payment securely via Razorpay.',
      '4. Ads are immediately removed for your account.',
      '',
      'Free ad-free access:',
      '→ Watch a reward ad to get 30 minutes of ad-free experience.',
      '→ Refer friends using your referral code to earn longer ad-free periods.',
      '',
      'Refunds:',
      '→ Refunds are available within 30 days if a verified technical fault prevents app use.',
      '→ Contact us via the Play Store developer page with your Order ID.',
      '',
      'Note: Subscription requires a Google account sign-in to link to your account. Internet connection is required for subscription verification.',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      '✓ Subscription verification (Razorpay)',
      '✓ Push notifications (Firebase)',
      '✓ Displaying ads (Google AdMob)',
      '',
      '✓ Compliant with Play Store and Indus App Store policies.',
      '✓ Compliant with GDPR and Indian IT Act.',
      '',
