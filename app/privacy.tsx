    ...
    <View style={styles.root}>
      ...
      >
        ...
        <PolicySection
          ...
          content="Refund policy depends on which store you purchased from. All sales are otherwise final because subscriptions are digital goods with no recoverable cost.\n\n— GOOGLE PLAY STORE —\nRefunds are subject to Google Play's standard refund policy. You can request a refund directly in the Play Store app within 48 hours of purchase:\nPlay Store → Profile icon → Payments & subscriptions → Order history → StatusVault order → Request a refund.\nFor issues beyond 48 hours, contact us with your Google Order ID at ahmedsameerbinan2@gmail.com.\n\n— INDUS APP STORE / OTHER STORES (Razorpay) —\nWe will issue a refund if any of the following apply:\n• You were charged but Pro was not activated due to a verified technical failure (contact us within 7 days with your Razorpay Payment ID).\n• You were charged twice for the same period.\n• The app is fundamentally non-functional on your device and we cannot resolve the issue within 14 days of your report.\n\nREFUND WINDOWS BY PLAN (Razorpay only):\n• 1 Month (₹29): Refund only in the cases listed above. Because the transaction value is small and payment gateway fees consume a large share, refunds are not issued for change-of-mind on this plan.\n• 3 Months (₹79) / 1 Year (₹149): Full refund within 48 hours of purchase if the request meets the criteria above.\n\nHOW TO REQUEST (Razorpay): Email ahmedsameerbinan2@gmail.com with your Razorpay Payment ID, registered email, and description of the issue. Refund decisions are made within 5 business days. Approved refunds are returned to the original payment method within 7–10 business days.\n\nEXCLUSIONS (both stores): Refunds will NOT be provided for change of mind, incompatibility with non-standard custom ROMs, loss of access caused by changes to your own Google account, or removal of the app from a store after purchase.\n\nANTI-ABUSE: Users who initiate a bank chargeback in lieu of using the refund process above will be permanently banned from future purchases."
        />
