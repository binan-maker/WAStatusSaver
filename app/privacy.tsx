    ...
    <View style={styles.root}>
      ...
      >
        ...
        <PolicySection
          ...
          content="All subscription sales are final because subscriptions are digital goods. Refunds are issued only in the limited cases described below.\n\n— GOOGLE PLAY STORE —\nRefunds are governed entirely by Google Play's standard refund policy. Request directly from the Play Store app within 48 hours: Play Store → Profile → Payments & subscriptions → Order history → StatusVault → Request a refund. Beyond 48 hours, refunds are at Google's sole discretion. We do not handle Play Store refunds.\n\n— INDUS APP STORE / OTHER STORES (Razorpay) —\nA refund will be considered ONLY if you contact us within 48 HOURS of purchase at ahmedsameerbinan2@gmail.com with your Razorpay Payment ID, AND any of the following applies:\n• You were charged but Pro was not activated due to a verified technical failure on our side.\n• You were charged twice for the same plan period.\n• The app is fundamentally non-functional on your device and we cannot resolve the issue within 14 days of your report.\n\nIMPORTANT — DEDUCTIONS FROM REFUND AMOUNT (Razorpay only):\nApproved refunds are issued NET, not gross. The following non-recoverable amounts are deducted from your refund:\n• Payment-gateway processing fee (~2–3% retained by Razorpay)\n• GST and applicable taxes already remitted to the government\n• Platform / store commission already remitted to the app store\n• A flat ₹10 administrative handling charge per refund\nThe net refund will be lower than the price you paid. By making a purchase you accept these deductions.\n\nREFUND WINDOWS BY PLAN (Razorpay only):\n• 1 Month (₹29): Refunds issued only in the technical-failure cases above. Change-of-mind refunds are not offered as gateway fees would consume the value.\n• 3 Months (₹79) / 1 Year (₹149): Net refund within 48 hours of purchase if the request meets the criteria above.\n\nNOT REFUNDABLE (both stores):\n• Change of mind or buyer's remorse after 48 hours.\n• Incompatibility with custom ROMs / non-standard Android forks.\n• Loss of access caused by changes to your own Google account.\n• Removal of the app from any store after your purchase.\n• Subscriptions consumed for more than 7 days of active use.\n• Accounts deleted via Settings → Delete Account (this voluntarily forfeits any remaining Pro time).\n• Free-Pro days from referrals or influencer codes (zero monetary value).\n\nHOW TO REQUEST (Razorpay): Email ahmedsameerbinan2@gmail.com with your Razorpay Payment ID, registered email, and a description of the issue. Refund decisions are made within 5 business days. Approved net refunds are credited within 7–10 business days.\n\nANTI-ABUSE: Users who initiate a bank chargeback in lieu of using the refund process above will be permanently banned from future purchases and forfeit all earned free-Pro time."
        />

        <PolicySection
          title="7a. Account Deletion & Pro Loss"
          content="If you delete your account from Settings → Delete Account, the following is FINAL and CANNOT be reversed:\n• Active Pro subscription is permanently forfeited; no refund (full or partial) is issued for remaining paid days.\n• Earned free-Pro days from referrals or influencer codes are erased.\n• Referral history, invite code, and ladder progress are erased.\n• Your Firebase Authentication record is queued for deletion. Subscription/payment records are retained for 90 days for accounting and audit, then permanently purged.\n• Re-installing the app or signing in again with the same Google account will NOT restore the lost Pro time.\n\nWhat is preserved on your device:\n• Statuses you previously saved into your phone's gallery 'StatusVault' album remain in your gallery and are not deleted by the app.\n\nBy confirming the in-app deletion dialog you acknowledge and accept these consequences."
        />
