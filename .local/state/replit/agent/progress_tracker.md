...
[x] 7. Added Test Screen C (app/test-video-rnv.tsx) — react-native-video player with identical URI resolution to Screen B.
     ↳ react-native-video installed via npm. Screen B now has a "→ Test Screen C" navigation button.
